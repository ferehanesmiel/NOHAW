    ...
    <footer className="bg-white border-t border-slate-200 pt-12 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
            ...
            <div>
                 <h3 className="text-lg font-bold text-slate-800 mb-4">NOHAW</h3>
                 <div className="flex flex-col space-y-3">
                    <Link to="/about-us" className="text-slate-500 hover:text-[--accent] text-sm transition-colors">{t('aboutUs')}</Link>
                    <Link to="/support" className="text-slate-500 hover:text-[--accent] text-sm transition-colors">{t('support')}</Link>
                 </div>
            </div>

            {/* Column 2: Founder / Powered By */}
            <div>
                <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">Powered By</h3>
                <div className="space-y-2">
                    <p className="text-xl font-black text-slate-800 tracking-tight">
                        ZEMEN<span className="text-[--accent]">DIGITAL</span>
                    </p>
                    <div className="text-sm text-slate-600">
                        <span className="font-semibold text-slate-700">Founder:</span> Ferehan Esmiel
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="space-y-3 text-sm text-slate-600">
                    ...
                    <p className="flex items-center gap-2">
                        ...
                        <span>+251 904 276 965 <span className="text-slate-300 mx-1">|</span> +251 472 879 67</span>
                    </p>
                    <p className="flex items-center gap-2">
